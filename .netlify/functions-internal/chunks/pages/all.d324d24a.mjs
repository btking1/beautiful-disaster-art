...
import 'magic-string';
import 'node:stream';
import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, b as addAttribute, d as renderHead, e as renderComponent, f as renderSlot } from '../astro.542e735a.mjs';
import 'html-escaper';
...
}, "/Users/bking/coding/beautiful-disaster-art/node_modules/@astrojs/image/components/Image.astro");
...
}, "/Users/bking/coding/beautiful-disaster-art/node_modules/@astrojs/image/components/Picture.astro");
...
const $$Nav = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<nav class="flex py-2 px-3 justify-between items-end astro-DMQPWCEC">
  <ul id="menu" data-visible="false" class="flex-col w-full top-0 left-0 h-full flex fixed overflow-hidden z-20 justify-center items-center gap-y-3 astro-DMQPWCEC">
    ${links.map((link) => {
...
const hearme = {"src":"/_astro/hearme.08f9cdcf.jpg","width":348,"height":296,"format":"jpg"};

const her = {"src":"/_astro/her.d944321b.jpg","width":266,"height":321,"format":"jpg"};

const muva = {"src":"/_astro/muva.d042537b.jpg","width":158,"height":232,"format":"jpg"};

const passion = {"src":"/_astro/passion.2186e6a3.jpg","width":226,"height":329,"format":"jpg"};
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const images = [
    ...
    { src: her, alt: "painting titled her", title: "her" },
    { src: muva, alt: "painting titled muva", title: "muva" },
    {
      src: passion,
      alt: "painting titled passion",
      title: "passion"
    },
    { src: "/assets/her.jpg", alt: "painting titled her", title: "her" }
  ];
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to Astro.", "class": "astro-J7PV25F6" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="flex flex-col items-start gap-11 px-3 py-3 astro-J7PV25F6">
    ...
    <section id="img-list"${addAttribute(`flex flex-col w-full p-5 gap-3 astro-J7PV25F6`, "class")}>
      ${images.map((image) => renderTemplate`${renderComponent($$result2, "Image", $$Image, { "id": "image", "src": image.src, "alt": image.alt, "data-load": "false", "width": 1600, "height": 900, "aspectRatio": "16:9", "format": "jpg", "class": "astro-J7PV25F6" })}`)}
    </section>
  </main>` })}
`;
