const id = "hearme.md";
						...
						const data = {title:"hear me",src:"/assets/hearme.jpg",excerpt:"This powerful painting measures 24 inches by 36 inches and features a central figure with outstretched arms against a background of deep blues and purples.",date:"03-22-23"};
						const _internal = {
							type: 'content',
							filePath: "/Users/bking/coding/beautiful-disaster-art/src/content/art/hearme.md",
